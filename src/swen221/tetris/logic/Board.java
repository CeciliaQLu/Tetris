...
public class Board {
	...
	/**
	 * @param sequence the next coming tetrominos
	 ...
	 *
	 * @return the width (number of squares) of this board 
	 */
	public int getWidth() {
		return width;
	}
	 ...
	 *
	 * @return the height (number of squares) of the board
	 */
	 ...
	 *
	 * @param tetromino Current active tetromino
	 */
	 ...
	 *
	 * @param t The next tetromino that will be put on the board
	 * @return true if there are enough spaces for the tetromino
	 */
