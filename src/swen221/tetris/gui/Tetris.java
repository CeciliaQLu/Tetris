...
public class Tetris extends JFrame {
	 ...
	 * 
	 * @param g a Game object that will be played
	 * @return JPanel as the canvas
	 */
	...
	/**
	 * create the canvas for the information area
	 * 
	 * @param g the game will be played
	 * @param nextTetrominoPanel the panel that has the next tetromino drawn on it
	 * @return the panel of the information area
	 */
	...
	/**
	 * Create the panel to draw the next tetromino
	 * 
	 * @param g the game is being played
	 * @return the panel for drawing the next tetromino
	 */
	 ...
	 * @param g  Game is being played
	 *        
	 * @return JPanel the cell canvas
	 */
	 ...
	 * @param g  Game
	 *        
	 * @return the panel for the next cell
	 */
	 ...
	 *
	 * @param tetromino an object of tetromino
	 * @return the color for the tetromino
	 */
	...
	/**
	 * this class represents a list of tetromino
	 *
	 */
	...
	private static class ClockThread extends Thread {
		...
		/**
		 * a list of panels for the game
		 */
		private final JPanel[] panels;
		/**
		 * delay between ticks in millisecond
		 */
		 ...
		 * @param panels a list of panels for the game
		 */
		 ...
		 *
		 * @param lines the current level
		 * @return the speed at which the game should be clocked
		 */
